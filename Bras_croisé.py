...
def essai():
    for i in range(0,3250):
        ...
        chemin_fichier = "C://Users//Pierre//Documents//PAF//openpose//output9wall//cam-table-wall_"+str(i * 10).zfill(12)+"_keypoints.json"
        ...
        #print(len(valeur_people))
        if len(valeur_people)>0:
            keypointp1=valeur_people[0]["pose_keypoints_2d"]
            #keypointp2=valeur_people[min(len(valeur_people),1)]["pose_keypoints_2d"]
            # Afficher la valeur
            #print(len(valeur_people))
            ...
            if epaule_g!=[0,0] and coude_g!=[0,0] and poigné_g!=[0,0] and epaule_d!=[0,0] and coude_d!=[0,0] and poigné_d!=[0,0]:
                ...
                if angle_g<120 and angle_d<120 and False:
                    
                    afficher_frame("cam-table-wall.mp4",i*10,epaule_g,coude_g,poigné_g,epaule_d,coude_d,poigné_d,tete)
